...
@server.PromptServer.instance.routes.get("/ggf_vhs/viewvideo")
@server.PromptServer.instance.routes.get("/ggf_vhs/viewvideo_legacy")
async def view_video(request):
    ...
    try:
        ...
        pass
    return resp
@server.PromptServer.instance.routes.get("/ggf_vhs/viewaudio")
...
query_cache = {}
@server.PromptServer.instance.routes.get("/ggf_vhs/queryvideo")
...
@server.PromptServer.instance.routes.get("/ggf_vhs/getpath")
@server.PromptServer.instance.routes.get("/ggf_vhs/getpath_legacy")
