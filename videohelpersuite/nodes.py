...
if 'GGF_video_formats' not in folder_paths.folder_names_and_paths:
...
def apply_format_widgets(format_name, kwargs):
    if os.path.exists(os.path.join(base_formats_dir, format_name + ".json")):
        ...
        video_format_path = folder_paths.get_full_path("GGF_video_formats", format_name)
...
class VideoCombine:
    ...
    def combine_video(
        ...
        **kwargs
        ...
        if extra_options.get('GGF_MetadataImage', True) != False:
        ...
        if format_type == "image":
            ...
            if audio is not None:
                try:
                    #safely check if audio produced by GGF_LoadVideo actually exists
        ...
        if extra_options.get('GGF_KeepIntermediate', True) == False:
    ...
    def INPUT_TYPES(s):
        ...
        return {
            ...
            "optional" : {
                ...
                "duration": ("FLOAT" , {"default": 0, "min": 0, "max": 10000000, "step": 0.01, "widgetType": "GGFTIMESTAMP"}),
                          }
        }
...
class LoadAudioUpload:
    ...
    def INPUT_TYPES(s):
        ...
        return {"required": {
                    "audio": (sorted(files),),},
                "optional": {
                    "start_time": ("FLOAT" , {"default": 0, "min": 0, "max": 10000000, "step": 0.01, "widgetType": "GGFTIMESTAMP"}),
                    "duration": ("FLOAT" , {"default": 0, "min": 0, "max": 10000000, "step": 0.01, "widgetType": "GGFTIMESTAMP"}),
                     },
                }
    ...
    def VALIDATE_INPUTS(s, audio, **kwargs):
        audio_file = folder_paths.get_annotated_filepath(strip_path(audio))
        return validate_path(audio_file, allow_none=True)
class AudioToGGFAudio:
    """Legacy method for external nodes that utilized GGF_AUDIO,
    GGF_AUDIO is deprecated as a format and should no longer be used"""
    @classmethod
    def INPUT_TYPES(s):
...
class GGFAudioToAudio:
    """Legacy method for external nodes that utilized GGF_AUDIO,
    GGF_AUDIO is deprecated as a format and should no longer be used"""
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {"ggf_audio": ("GGF_AUDIO",)}}
    CATEGORY = "GGF Video Helper Suite 🎥🅖🅖🅕/audio"
...
class SelectFilename:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {"filenames": ("GGF_FILENAMES",), "index": ("INT", {"default": -1, "step": 1, "min": -1})}}
    RETURN_TYPES = ("STRING",)
...
NODE_CLASS_MAPPINGS = {
    ...
    "GGF_LoadVideo": LoadVideoUpload,
    "GGF_LoadVideoPath": LoadVideoPath,
    "GGF_LoadVideoFFmpeg": LoadVideoFFmpegUpload,
    "GGF_LoadVideoFFmpegPath": LoadVideoFFmpegPath,
    "GGF_LoadImagePath": LoadImagePath,
    "GGF_LoadImages": LoadImagesFromDirectoryUpload,
    "GGF_LoadImagesPath": LoadImagesFromDirectoryPath,
    "GGF_LoadAudio": LoadAudio,
    "GGF_LoadAudioUpload": LoadAudioUpload,
    "GGF_AudioToGGFAudio": AudioToGGFAudio,
    "GGF_GGFAudioToAudio": GGFAudioToAudio,
    "GGF_PruneOutputs": PruneOutputs,
    "GGF_BatchManager": BatchManager,
    "GGF_VideoInfo": VideoInfo,
    "GGF_VideoInfoSource": VideoInfoSource,
    "GGF_VideoInfoLoaded": VideoInfoLoaded,
    "GGF_SelectFilename": SelectFilename,
    # Batched Nodes
    "GGF_VAEEncodeBatched": VAEEncodeBatched,
    "GGF_VAEDecodeBatched": VAEDecodeBatched,
    # Latent and Image nodes
    "GGF_SplitLatents": SplitLatents,
    "GGF_SplitImages": SplitImages,
    "GGF_SplitMasks": SplitMasks,
    "GGF_MergeLatents": MergeLatents,
    "GGF_MergeImages": MergeImages,
    "GGF_MergeMasks": MergeMasks,
    "GGF_GetLatentCount": GetLatentCount,
    "GGF_GetImageCount": GetImageCount,
    "GGF_GetMaskCount": GetMaskCount,
    "GGF_DuplicateLatents": RepeatLatents,
    "GGF_DuplicateImages": RepeatImages,
    "GGF_DuplicateMasks": RepeatMasks,
    "GGF_SelectEveryNthLatent": SelectEveryNthLatent,
    "GGF_SelectEveryNthImage": SelectEveryNthImage,
    "GGF_SelectEveryNthMask": SelectEveryNthMask,
    "GGF_SelectLatents": SelectLatents,
    "GGF_SelectImages": SelectImages,
    "GGF_SelectMasks": SelectMasks,
    "GGF_Unbatch": Unbatch,
    "GGF_SelectLatest": SelectLatest,
}
NODE_DISPLAY_NAME_MAPPINGS = {
    "GGF_VideoCombine": "Video Combine 🎥🅖🅖🅕",
    "GGF_LoadVideo": "Load Video (Upload) 🎥🅖🅖🅕",
    "GGF_LoadVideoPath": "Load Video (Path) 🎥🅖🅖🅕",
    "GGF_LoadVideoFFmpeg": "Load Video FFmpeg (Upload) 🎥🅖🅖🅕",
    "GGF_LoadVideoFFmpegPath": "Load Video FFmpeg (Path) 🎥🅖🅖🅕",
    "GGF_LoadImagePath": "Load Image (Path) 🎥🅖🅖🅕",
    "GGF_LoadImages": "Load Images (Upload) 🎥🅖🅖🅕",
    "GGF_LoadImagesPath": "Load Images (Path) 🎥🅖🅖🅕",
    "GGF_LoadAudio": "Load Audio (Path)🎥🅖🅖🅕",
    "GGF_LoadAudioUpload": "Load Audio (Upload)🎥🅖🅖🅕",
    "GGF_AudioToGGFAudio": "Audio to GGF_AUDIO 🎥🅖🅖🅕",
    "GGF_GGFAudioToAudio": "GGF_AUDIO to Audio 🎥🅖🅖🅕",
    "GGF_PruneOutputs": "Prune Outputs 🎥🅖🅖🅕",
    "GGF_BatchManager": "Meta Batch Manager 🎥🅖🅖🅕",
    "GGF_VideoInfo": "Video Info 🎥🅖🅖🅕",
    "GGF_VideoInfoSource": "Video Info (Source) 🎥🅖🅖🅕",
    "GGF_VideoInfoLoaded": "Video Info (Loaded) 🎥🅖🅖🅕",
    "GGF_SelectFilename": "Select Filename 🎥🅖🅖🅕",
    # Batched Nodes
    "GGF_VAEEncodeBatched": "VAE Encode Batched 🎥🅖🅖🅕",
    "GGF_VAEDecodeBatched": "VAE Decode Batched 🎥🅖🅖🅕",
    # Latent and Image nodes
    "GGF_SplitLatents": "Split Latents 🎥🅖🅖🅕",
    "GGF_SplitImages": "Split Images 🎥🅖🅖🅕",
    "GGF_SplitMasks": "Split Masks 🎥🅖🅖🅕",
    "GGF_MergeLatents": "Merge Latents 🎥🅖🅖🅕",
    "GGF_MergeImages": "Merge Images 🎥🅖🅖🅕",
    "GGF_MergeMasks": "Merge Masks 🎥🅖🅖🅕",
    "GGF_GetLatentCount": "Get Latent Count 🎥🅖🅖🅕",
    "GGF_GetImageCount": "Get Image Count 🎥🅖🅖🅕",
    "GGF_GetMaskCount": "Get Mask Count 🎥🅖🅖🅕",
    "GGF_DuplicateLatents": "Repeat Latents 🎥🅖🅖🅕",
    "GGF_DuplicateImages": "Repeat Images 🎥🅖🅖🅕",
    "GGF_DuplicateMasks": "Repeat Masks 🎥🅖🅖🅕",
    "GGF_SelectEveryNthLatent": "Select Every Nth Latent 🎥🅖🅖🅕",
    "GGF_SelectEveryNthImage": "Select Every Nth Image 🎥🅖🅖🅕",
    "GGF_SelectEveryNthMask": "Select Every Nth Mask 🎥🅖🅖🅕",
    "GGF_SelectLatents": "Select Latents 🎥🅖🅖🅕",
    "GGF_SelectImages": "Select Images 🎥🅖🅖🅕",
    "GGF_SelectMasks": "Select Masks 🎥🅖🅖🅕",
    "GGF_Unbatch":  "Unbatch 🎥🅖🅖🅕",
    "GGF_SelectLatest": "Select Latest 🎥🅖🅖🅕",
}
